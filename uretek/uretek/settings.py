"""
Django settings for uretek project.
...
SECRET_KEY = 'e_+*$pv%516^v4zr8nl*qm4l-lp!t9mb157bmpere2tode3xe@'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/Users/apple/PycharmProjects/Uretekweb/uretek/template',
                '/Users/apple/PycharmProjects/Uretekweb/uretek/static/constra-free/themes/constra free',
                 ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'uretek.wsgi.application'
